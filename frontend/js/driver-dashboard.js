  ...
  try {
    ...
    let html = `
      ...
      <div class='mb-4 grid grid-cols-1 gap-2'>
        <div><span class='font-semibold text-gray-700'>Status:</span> <span class='ml-2'>${
          order.status
        }</span></div>
        ...
        <div class='mt-2'><span class='font-semibold text-gray-700'>Harga:</span> <span class='ml-2'>Rp ${
          order.price?.toLocaleString() || "0"
        }</span></div>
        <div><span class='font-semibold text-gray-700'>Jarak:</span> <span class='ml-2'>${
          order.distance?.toLocaleString() || "0"
        } km</span></div>
        <div><span class='font-semibold text-gray-700'>Pembayaran:</span> <span class='ml-2'>${paymentStatus}</span></div>
        <div><span class='font-semibold text-gray-700'>Customer:</span> <span class='ml-2'>${
          order.customerName || "-"
        }</span></div>
      </div>
    `;
